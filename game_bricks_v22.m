...
% - when you win or lose you see: (main menu button) --- (exit button)
% I think I want these to appear BEFORE everything is deleted
...
maxlvl = 1; %highest lvl number required to "win"
...
while ready ~= 1 && exit ~= 1
    ...
    if XPos > -2 && XPos < 11 && YPos > -8 && YPos < 8
        %Mouse is over arrows
        mode = keys;
        %Set highlight_p
        set(highlight_p,'XData',highlightX+arrows_X);
    elseif XPos > 11 && XPos < 26 && YPos > -8 && YPos < 8
